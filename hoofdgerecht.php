<?php 
	...
	$hoofdgerechten = $db->select(" SELECT menuitems.ID, menuitems.Code, menuitems.Naam, menuitems.Prijs ,gerechtsoorten.ID AS soort_ID ,gerechtcategorieen.Naam AS soort, gerechtsoorten.Naam AS soort_naam FROM menuitems 
	...
	$columns = array_keys($hoofdgerechten[0]);
	$row_data = array_values($hoofdgerechten);
...
<body>
	...
	<table>
		...
		<tbody><h1>Hoofdgerechten Editen of Verwijderen</h1>
